...
public class DataProcessing extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int Yes = JOptionPane.showConfirmDialog(null,"Η βάση δεδομένων θα διαγραφεί, είστε σίγουροι για έξοδο;","Έξοδος", JOptionPane.YES_NO_OPTION);
